  ...
  _createClass(Matrix, [{
    ...
    */
    ...
    value: function setElement(row, column, value) {
      if (_typeof(value) !== _typeof(this.mElements[0]) || typeof row !== "number" || typeof column !== "number") throw new MatrixError("Invalid arugment", 606, {
        value: value,
        row: row,
        column: column
      });
    ...
    value: function add(B) {
      ...
      if (this.dataType !== B.dataType) {
        throw new MatrixError("Matrices have different element types", 806, {
          AType: _typeof(this.mElements[0]),
          BType: _typeof(B.mElements[0])
        });
      }
...
export { Constants, Matrix, MatrixError, math };
